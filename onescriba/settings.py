"""
Django settings for onescriba project.
...
SECURE_SSL_REDIRECT = (not DEBUG) and _env_bool('DJANGO_SECURE_SSL_REDIRECT', default=True)
...
if DEBUG:
    try:
        importlib.import_module('django_browser_reload')
...
WSGI_APPLICATION = 'onescriba.wsgi.application'
